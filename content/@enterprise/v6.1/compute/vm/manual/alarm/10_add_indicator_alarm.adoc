...
. 点击**指标告警** > *绑定指标告警策略*，弹出**选择要绑定的指标告警策略**窗口。
+
...
+
image::/images/cloud_service/compute/vm/vm_alarm_indicator_win.png[,60%]
...
+
image::/images/cloud_service/compute/vm/vm_alarm_indicator_display.png[]
...
+
image::/images/cloud_service/compute/vm/vm_alarm_indicator_cat.png[,70%]
...
. 点击**下一步**，配置告警规则。
+
image::/images/cloud_service/compute/vm/vm_alarm_indicator_rule.png[,70%]
...
| 触发条件
| 选择告警触发条件，可选择**资源变为告警时**和**资源恢复正常时**。

| 告警次数
| 当资源持续处于**告警**状态时，连续发送告警通知的次数。最多为 100 次。
