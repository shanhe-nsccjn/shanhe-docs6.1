...
. 点击**鼠标右键**，弹出菜单窗口。
+
image::/images/cloud_service/compute/vm/vm_tag_bind.png[,70%]
...
+
image::/images/cloud_service/compute/vm/vm_tag_bind_win.png[,70%]
...
+
image::/images/cloud_service/compute/vm/vm_tag_bind_list.png[,70%]
