...
title: "快速入门"
draft: false
keywords: SDK, ShanHe, 山河云, 创建云服务器, 云计算
---
使用 shanhe-sdk 前请先在 link:https://console.shanhe.com/access_keys/[{console_name}] 申请 access key，申请后便可以自由使用了。

include::../../../../../../_components/note.adoc[]
如果您期望在IAM身份的信任设备上使用 shanhe-sdk ，也可以不用申请 access key ，而是到 link:https://console.shanhe.com/iam/roles[IAM 控制面板]创建基于该信任设备的IAM即可。
