...
=== 下载安装
. 直接link:https://github.com/qingstor/qsctl/releases[点击此处]，根据客户端操作系统版本，下载相应安装包。若无特殊要求，建议下载最新版本。
// +
...
. 在 link:https://console.shanhe.com/access_keys/[{console_name}]申请 API 密钥，并下载保存。
