...
为方便查看 HBase 官网监控信息，请参考 *VPN 隧道指南* 配置 VPN。

include::../../../../../../_components/table_footer.adoc[]

image::/images/cloud_service/bigdata/hbase/hbase_monitor.png[HBase 基本服务监控信息]

image::/images/cloud_service/bigdata/hbase/hdfs.png[HDFS 概览]
...
+
image::/images/cloud_service/bigdata/hbase/manual_node_monitor.png[节点监控]
...
*实时监控为关闭时*
+
image::/images/cloud_service/bigdata/hbase/manual_resource_monitor.png[]
+
*实时监控为开启时*
+
image::/images/cloud_service/bigdata/hbase/manual_resource_monitor_realtime.png[]
