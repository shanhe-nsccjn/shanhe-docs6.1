...
+
image::/images/cloud_service/bigdata/qingmr/hadoop_proxy_user.png[Hadoop 代理用户]
+

include::../../../../../_components/note.adoc[]

hosts 或 groups 中填写 `*` 代表任意 host 或任意 group 。 hosts 和 groups 中也可以填写以逗号分割的 host name/ip 或者 group 名。详见 hadoop 官方文档 link:http://hadoop.apache.org/docs/r2.7.3/hadoop-project-dist/hadoop-common/Superusers.html[Proxy user setting]。
...
+
image::/images/cloud_service/bigdata/qingmr/yarn_ui_proxy.png[YARN applications UI]
...
+
image::/images/cloud_service/bigdata/qingmr/update_scheduler.png[更新调度器]
+
image::/images/cloud_service/bigdata/qingmr/update_scheduler_submit.png[更新调度器]

. 在配置参数页面切换到相应调度器。
+
image::/images/cloud_service/bigdata/qingmr/select_scheduler.png[选择调度器]
+
...
image::/images/cloud_service/bigdata/qingmr/yarn_log_aggregation.png[YARN log 收集]
...
image::/images/cloud_service/bigdata/qingmr/hdfs_yarn_heap_size.png[YARN heap size]
