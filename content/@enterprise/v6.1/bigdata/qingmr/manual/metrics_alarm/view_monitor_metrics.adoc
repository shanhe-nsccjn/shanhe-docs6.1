...
* \http://<主节点 IP>:8088
+
image::/images/cloud_service/bigdata/qingmr/yarn_monitoring.png[YARN]

* \http://<主节点 IP>:8088/ui2  ( yarn 新版 UI，从 QingMR 2.0.0 开始支持)
+
image::/images/cloud_service/bigdata/qingmr/yarn_monitoring_ui2.png[YARN]

* \http://<HDFS-MASTER-IP>:50070
+
image::/images/cloud_service/bigdata/qingmr/hdfs_monitoring.png[YARN]

* \http://<主节点 IP>:8080
+
image::/images/cloud_service/bigdata/qingmr/spark_monitoring.png[YARN]

* \http://<主节点 IP>:10002（从 QingMR 1.3.0 开始支持）
+
image::/images/cloud_service/bigdata/qingmr/hive_server2_monitoring.png[HIVE_SERVER2]
+
...
+
image::/images/cloud_service/bigdata/qingmr/flink_session_dashboard.png[Flink session WEB UI]
+

include::../../../../../../_components/note.adoc[]

Flink YARN Session WEB UI 展示的是此 Session 正在运行的 job 和 1 小时内的已完成 job，可以通过此 WEB UI 向 Flink YARN Session 提交 job。 `JobManager-Web-Interface` 为 JobManager 地址，详见 link:../../../developer_manual/flink[创建 Flink YARN Session]。

include::../../../../../../_components/table_footer.adoc[]

* \http://< HDFS-MASTER-IP >:8082（从 QingMR 2.5.0 开始支持）
+
image::/images/cloud_service/bigdata/qingmr/flink_dashboard.png[Flink historyserver WEB UI]
+
...
+
image::/images/cloud_service/bigdata/qingmr/manual_node_monitor.png[节点监控]
...
*实时监控为关闭时*
+
image::/images/cloud_service/bigdata/qingmr/manual_resource_monitor.png[]
+
*实时监控为开启时*
+
image::/images/cloud_service/bigdata/qingmr/manual_resource_monitor_realtime.png[]
