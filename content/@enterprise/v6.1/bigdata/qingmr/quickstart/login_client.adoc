...
keywords: 云计算,大数据,QingMR,QingMR 实例,QingMR Client,快速入门
weight: 12
collapsible: false
draft: false
---
...
* QingMR 集群已有 Client 节点。若创建集群时未创建 Client 节点，可通过link:../../manual/mgt_node/add_node[新增节点]功能进行添加。
...
. 选择**节点**页签，进入节点列表页面。
+
image::/images/cloud_service/bigdata/qingmr/qingmr_node_list.png[登录 Client]
...
+
image::/images/cloud_service/bigdata/qingmr/Client_web_terminal.png[Web 终端]
