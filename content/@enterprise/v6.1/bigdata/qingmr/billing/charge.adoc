...
账号支持多种充值途径：支付宝、网上银行、微信支付、线下银行转账。可在link:https://console.shanhe.com/finance/wallet/[充值页面]选择。  +
...
默认是发送给账号的注册手机号及通知邮箱，如果您希望自定义接收者列表，可在消息中心的link:https://console.shanhe.com/notify/receiveConfig[消息接收配置页面]中修改“财务消息”对应的消息接收人。
